# Implemented Queue to prevent corruption of txt or json files
import os
import re
import json
import random
...
from f_vars import (
    verb_create, verb_show, noun_relationship, scatterplot_name_var,
...
def generate_files(w2d, str_in, vars, queue, batch_size=1):
    txt_batch = []
    json_batch = []
    for i in range(1):
        combination = []
...
def write2files():
    with open('empty_tags/scatter_empty_tagsV2.txt', 'r') as txt_in:
    ...
    txt_path = "prompts/scatterV6.txt"
    json_path = "json/scatterV6.json"
